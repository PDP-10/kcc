...
extern NODE *ndef(int, TYPE *, int, NODE *, NODE *),
	    *ndefop(int),			/* Auxiliary variations */
	    *ndeft( int, TYPE *), 
	    *ndeftf(int, TYPE *, int), 
	    *ndeftl(int, TYPE *, NODE *), 
	    *ndeftr(int, TYPE *, NODE *),
	    *ndefl( int, NODE *), 
	    *ndefr( int, NODE *), 
	    *ndeflr(int, NODE *, NODE *),
	    *ndefident(SYMBOL *),
	    *ndeficonst(INT);		/* For CCSTMT, CCTYPE */
extern void nodedump(NODE *),		/* CC */
	    nodeinit(void);
extern int  nodeidx(NODE *);		/* CCERR */
#if 0
